...
echo ""
echo -e "💻 ${GREEN}Setup Other Devices:${NC}"
echo "   1. Install Tailscale and join your tailnet"
echo "   2. DNS is automatic via admin console setup above"
echo ""
echo -e "🧪 ${GREEN}Test from any Tailscale device:${NC}"
if [ -n "$TEST_DOMAIN" ]; then
echo -e "   ${YELLOW}dig @$TAILSCALE_IP $TEST_DOMAIN${NC}"
echo -e "   ${YELLOW}nslookup $TEST_DOMAIN $TAILSCALE_IP${NC}"
else
echo -e "   ${YELLOW}dig @$TAILSCALE_IP yourdomain.dev${NC}"
echo -e "   ${YELLOW}nslookup yourdomain.dev $TAILSCALE_IP${NC}"
fi
echo ""
...
echo ""
echo -e "🔒 ${GREEN}HTTPS Setup (One-time per device):${NC}"
...
echo ""
echo -e "🔄 ${GREEN}Automatic updates:${NC}"
...
echo -e "   Stop:    ${YELLOW}sudo brew services stop dnsmasq${NC}"
echo -e "   Start:   ${YELLOW}sudo brew services start dnsmasq${NC}"
echo -e "   Restart: ${YELLOW}sudo brew services restart dnsmasq${NC}"
echo -e "   Status:  ${YELLOW}brew services list | grep dnsmasq${NC}"
echo ""
